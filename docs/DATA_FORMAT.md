...
Wspólne pola: id, kind, title, createdAt, updatedAt, revision, caseIds, tags, relatedIds, epistemic. deletedAt oznacza kosz. demo: true oznacza fikcyjne dane. importedOriginalId wskazuje pierwotne ID po kolizji importu. Typy i pola definiuje `js/schema.js`.
